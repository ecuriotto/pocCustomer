...
class AddEquipment implements RestApiController {
    ...
    RestApiResponse doHandle(HttpServletRequest request, RestApiResponseBuilder responseBuilder, RestAPIContext context) {
        ...
        */
		...
		head.add("app","POS")
		head.add("description","test description")
		//def body = ["Order": order]
			
		invocationBuilder.headers(head);
		def uselessBody = "{\"test\":\"useless\"}"
		String response = invocationBuilder.post(Entity.json(uselessBody)).readEntity(String.class);
		LOGGER.info("Addequipment response: " + response);
