...
class GetWatchBySN implements RestApiController {

    private static final Logger LOGGER = LoggerFactory.getLogger(GetWatchBySN.class)
		...
		if (serial == null) {
			...
			try {
				...
				"""<?xml version='1.0' encoding='UTF-8'?>
						<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:cred="http://lawson.com/ws/credentials" xmlns:get="http://audemarspiguet.com/APWS/getWatchesBySN">	   
							<soapenv:Body>
								<get:getWatchesBySN>
									<get:pCompany>100</get:pCompany>
									<get:pSerialNumber>"""+serial+"""</get:pSerialNumber>
								</get:getWatchesBySN>
							</soapenv:Body>
						</soapenv:Envelope>"""
				)
	...
	def getOutput(def response) {
		...
		response.getWatchesBySNResponse.WatchCollection.WatchItem.collect{
			w -> convertToMap(w)
		}
