...
class GetTechnicalData implements RestApiController {

    private static final Logger LOGGER = LoggerFactory.getLogger(GetTechnicalData.class)
		...
		if (serial == null) {
			...
			try {
				...
				"""<?xml version='1.0' encoding='UTF-8'?>
						<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:cred="http://lawson.com/ws/credentials" xmlns:get="http://audemarspiguet.com/APWS/getTechnicalDatas">	   
							<soapenv:Body>
								<get:getTechnicalDatas>
				...
				result = ["getTechnicalDatas":getOutput(response)];
	...
	def getOutput(def response) {
		...
		response.getTechnicalDatasResponse.DataCollection.DataItem.collect{
			w -> convertToMap(w)
		}
